    ...
    VStack(spacing: 0.0) {
      ...
      ZStack(alignment: .topLeading) {
        ...
        Circle()
          ...
          .offset(x: animate ? 50 : 20, y: animate ? 70 : 30)
        
        Circle()
          .frame(width: 200, height: 230)
          .foregroundColor(Color("pink"))
          .blur(radius: animate ? 70 : 100)
          .offset(x: animate ? 150 : 70, y: animate ? 90 : 100)
